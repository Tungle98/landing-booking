    ...
    <base-nav class="navbar-main" transparent type="" effect="light" expand>
      ...
      <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
        <!-- <base-dropdown class="nav-item" menu-classes="dropdown-menu-xl">
          ...
          >
            ...
            <span class="nav-link-inner--text">Giá tốt</span>
          </a>
        ...
        <li class="nav-item d-none d-lg-block ml-lg-4">
          <a href="" target="_blank" rel="noopener" class="">
            <span class="nav-link-inner--text">
              <router-link to="/hotdeal" class="text-white"
                >GIÁ TỐT</router-link
              ></span
            >
          </a>
        ...
        <li class="nav-item d-none d-lg-block ml-lg-4">
          <a href="" target="_blank" rel="noopener" class="">
            <span class="nav-link-inner--text">
              <router-link to="/top-ten-course" class="text-white"
                >TOP 10 SÂN TỐT</router-link
              ></span
            >
          </a>
        </li>
        <li class="nav-item d-none d-lg-block ml-lg-4">
          <a href="" target="_blank" rel="noopener" class="">
            <span class="nav-link-inner--text">
              <router-link to="/good-yard-area" class="text-white"
                >CHỌN THEO KHU VỰC</router-link
              ></span
            >
          </a>
        </li>
        <li class="nav-item d-none d-lg-block ml-lg-4">
          <a href="" target="_blank" rel="noopener" class="">
            <span class="nav-link-inner--text">
              <router-link to="/stayplay" class="text-white"
                >STAY&PLAY</router-link
              ></span
            >
          </a>
        </li>
      ...
      <ul class="navbar-nav align-items-lg-center ml-lg-auto">
        <li class="nav-item d-none d-lg-block ml-lg-4">
          ...
          >
            <span class="nav-link-inner--text">
              <router-link to="/register">Đăng kí</router-link></span
            >
          </a>
        </li>
        <li class="nav-item d-none d-lg-block ml-lg-4">
